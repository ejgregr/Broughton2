...
raster_dir <- 'C:/Data/Git/Broughton_descriptors/LSSM'
#raster_dir <- 'C:/Data/Git/Broughton/Data/Predictors'
data_dir   <- 'C:/Data/Git/Broughton2/Data'
rmd_dir    <- 'C:/Data/Git/Broughton2' 
...
LoadPredictors2 <- function( pred_dir ) {
...
# random sample used in the classification ----
# Assembly required with the classified pixels before plotting. Function by ChatGPT.
